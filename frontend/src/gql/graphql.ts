...
export type InventoryLogsQuery = { __typename?: 'Query', inventoryLogs: { __typename?: 'InventoryLogsPagedDto', totalCount: number, items: Array<{ __typename?: 'InventoryLogDto', id: number, inventoryRecordId: number, serialNumbers: Array<string>, timestamp: any, action: Action, attribute?: InventoryAttribute | null, prevValue?: string | null, nextValue?: string | null, asset: { __typename?: 'AssetDto', id: number, name: string }, author?: { __typename?: 'UserDto', id: number, username: string } | null }>, usedLocations: Array<{ __typename?: 'LocationDto', id: number, name: string }>, usedResponsibles: Array<{ __typename?: 'ResponsibleDto', id: number, name: string }>, usedStatuses: Array<{ __typename?: 'StatusDto', id: number, name: string }> } };
